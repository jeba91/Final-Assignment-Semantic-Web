...
$('#link14').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in dbpedia:Netherlands. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';

	$.get('/sparql',data={'endpoint': endpoint, 'query': query, 'format': format}, function(json){console.log(json);
...
$('#link15').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in dbpedia:England. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link16').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in dbpedia:Germany. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link17').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in dbpedia:France. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link18').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in dbpedia:United_States. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link19').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where {?Link rdf:type own:University. ?Link own:Is_located_in own:Amsterdam. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link20').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where {?Link rdf:type own:University. ?Link own:Is_located_in <http://dbpedia.org/resource/New_Haven,_Connecticut>. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link21').on('click', function(e){

	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in dbpedia:Philadelphia. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link22').on('click', function(e){
	...
	var query = "PREFIX dbpedia: <http://dbpedia.org/resource/> select distinct ?Link ?University where { ?Link rdf:type own:University. ?Link own:Is_located_in own:London. OPTIONAL{?Link rdfs:label ?University}}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
...
$('#link23').on('click', function(e){

	var query = "select distinct ?CourseID ?Course where {?CourseID rdf:type own:Courses. ?CourseID rdfs:label ?Course. ?CourseID own:teaches <http://data.open.ac.uk/topic/languages>}";
	var endpoint = 'http://localhost:5820/UniTime/query';
	var format = 'JSON';
